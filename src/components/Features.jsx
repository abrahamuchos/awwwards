    ...
    <section className='bg-black pb-52'>
      <div className="container mx-auto px-3 md:px-10">
        <div className="px-5 py-32">
          <p className='font-circular-web text-lg text-blue-50'>Intro the Metagame</p>
        ...
        <BentoTilt className="border-hsla relative mb-7 w-full overflow-hidden rounded-md md:h-[65vh]">
          <BentoCard
